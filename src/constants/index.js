...
export const skillText = [
    {
        title: '문제를 해결하는 즐거움',
        desc: '나는 문제를 해결하는 과정을 즐긴다. 복잡한 문제를 마주할 때마다 새로운 접근법을 찾고 해결하는 것이 나에게 큰 만족감을 준다. 이 과정에서 배운 것들이 나를 더 나은 개발자로 성장하게 만든다.'
    },
    {
        title: '팀워크의 가치',
        desc: '혼자 일하는 것도 좋지만, 팀과 함께 일할 때 더 큰 시너지를 느낀다. 서로 다른 아이디어를 공유하고 협력하는 과정에서 더 나은 결과물을 만들어낼 수 있다. 팀워크는 나에게 중요한 가치이다.'
    },
    {
        title: '지속적인 개선',
        desc: '현재에 안주하지 않고 항상 더 나은 방법을 찾기 위해 노력한다. 작은 개선이라도 꾸준히 시도하면 큰 변화를 가져올 수 있다. 끊임없이 스스로를 개선해 나가는 것이 내가 추구하는 목표이다.'
    }
]
...
export const contactText = [
    ...
    {
        link: 'mailto:fdcwrt@naver.com',
        title: 'mail : fdcwrt@naver.com'
    }
]

...
.port__inner {
    ...
    .port__wrap {
        ...
        .port__item {
            ...
            &.p6 {
                background-color: var(--suvBg100);
            }
            &.p7 {
                background-color: var(--suvBg200);
            }
            &.p8 {
                background-color: var(--suvBg300);
            }
            &.p9 {
                background-color: var(--suvBg400);
            }
            &.p10 {
                background-color: var(--suvBg500);
            }
            .num {
                font-size: 2rem;
